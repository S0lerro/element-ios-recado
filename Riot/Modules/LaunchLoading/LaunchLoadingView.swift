...
final class LaunchLoadingView: UIView, NibLoadable, Themable {
    ...
    override func awakeFromNib() {
        ...
        // Полностью отключаем анимацию ElementView
        ...
        // Делаем ElementView статичным (или скрываем его, если нужно)
        self.animationView.isHidden = true // Если хотите скрыть совсем
    }
